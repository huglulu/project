...
define('com/carousel',['jquery'],function($) {
...
define('com/waterfall',['jquery'],function($){
	waterFall = {
		arrColHeight: [],
...
;
 define('com/ajaxModule',['jquery','com/waterfall'],function($,waterFall){        //waterfall文件目录要带com/，否则报错
  console.log(1);
   var ajaxModule = {
      init: function($load){
        this.$load = $load;
...
define('com/exposure',['jquery'],function($) {
...
define('app/index',['jquery','com/carousel','com/goTop','com/ajaxModule','com/waterfall','com/exposure'],function($,Carousel,goTop,ajaxModule,waterFall,Exposure){
